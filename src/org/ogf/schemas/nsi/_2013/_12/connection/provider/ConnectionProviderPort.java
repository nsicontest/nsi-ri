...
public interface ConnectionProviderPort {
    ...
    @RequestWrapper(localName = "queryResultSync", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "org.ogf.schemas.nsi._2013._12.connection.types.QueryResultType")
    @WebMethod(action = "http://schemas.ogf.org/nsi/2013/12/connection/service/queryResultSync")
    @ResponseWrapper(localName = "queryResultSyncConfirmed", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "org.ogf.schemas.nsi._2013._12.connection.types.QueryResultConfirmedType")
    public java.util.List<org.ogf.schemas.nsi._2013._12.connection.types.QueryResultResponseType> queryResultSync(
    ...
    public org.ogf.schemas.nsi._2013._12.connection.types.GenericAcknowledgmentType querySummary(
        @WebParam(partName = "querySummary", name = "querySummary", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types")
        org.ogf.schemas.nsi._2013._12.connection.types.QueryType querySummary,
     ...
     *             
     */
    @RequestWrapper(localName = "provision", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "org.ogf.schemas.nsi._2013._12.connection.types.GenericRequestType")
     ...
     *             
     */
    @RequestWrapper(localName = "terminate", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "org.ogf.schemas.nsi._2013._12.connection.types.GenericRequestType")
     ...
     *             
     */
    @RequestWrapper(localName = "release", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "org.ogf.schemas.nsi._2013._12.connection.types.GenericRequestType")
     ...
     *             
     */
    @RequestWrapper(localName = "reserveAbort", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "org.ogf.schemas.nsi._2013._12.connection.types.GenericRequestType")
     ...
     *             
     */
    @RequestWrapper(localName = "reserveCommit", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "org.ogf.schemas.nsi._2013._12.connection.types.GenericRequestType")
    ...
    public org.ogf.schemas.nsi._2013._12.connection.types.GenericAcknowledgmentType queryRecursive(
        @WebParam(partName = "queryRecursive", name = "queryRecursive", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types")
        org.ogf.schemas.nsi._2013._12.connection.types.QueryType queryRecursive,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<org.ogf.schemas.nsi._2013._12.framework.headers.CommonHeaderType> header
    ) throws org.ogf.schemas.nsi._2013._12.connection._interface.ServiceException;
     ...
     *             
     */
    @RequestWrapper(localName = "reserve", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "org.ogf.schemas.nsi._2013._12.connection.types.ReserveType")
    @WebMethod(action = "http://schemas.ogf.org/nsi/2013/12/connection/service/reserve")
    @ResponseWrapper(localName = "reserveResponse", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "org.ogf.schemas.nsi._2013._12.connection.types.ReserveResponseType")
    public void reserve(
    ...
    public org.ogf.schemas.nsi._2013._12.connection.types.QueryNotificationConfirmedType queryNotificationSync(
        ...
        org.ogf.schemas.nsi._2013._12.connection.types.QueryNotificationType queryNotificationSync,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<org.ogf.schemas.nsi._2013._12.framework.headers.CommonHeaderType> header
    ) throws org.ogf.schemas.nsi._2013._12.connection._interface.Error;
     ...
     *             
     */
    @RequestWrapper(localName = "queryNotification", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "org.ogf.schemas.nsi._2013._12.connection.types.QueryNotificationType")
    ...
    public org.ogf.schemas.nsi._2013._12.connection.types.QuerySummaryConfirmedType querySummarySync(
        ...
        org.ogf.schemas.nsi._2013._12.connection.types.QueryType querySummarySync,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<org.ogf.schemas.nsi._2013._12.framework.headers.CommonHeaderType> header
    ) throws org.ogf.schemas.nsi._2013._12.connection._interface.Error;
     ...
     *             
     */
    @RequestWrapper(localName = "queryResult", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "org.ogf.schemas.nsi._2013._12.connection.types.QueryResultType")
